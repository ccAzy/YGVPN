...
```
清理 ──► 安装 ──► BBR ──► 订阅 ──► Hysteria2 ──► Argo ──► 域名分流 ──► 验证 ──► TG推送
```
...
Ubuntu 22.04+ 自带 BBR，**秒开**。老内核才走慢路径（下载新内核，需 2~5 分钟 + 重启）。
...
- ⚠️ `servers.json` 含明文密码，**不入库、不分享**
- Token 通过环境变量传入，不写死在代码里
- 仓库**零密钥、零 IP、零隐私** ✅ 可公开

---

<p align="center">
  <sub>MIT License · 原作者 <a href="https://github.com/yonggekkk/sing-box-yg">yonggekkk/sing-box-yg</a></sub>
</p>
