...
| **IP 纯净度检测** | 检测机房/代理标签、ISP、ASN，判断流媒体/AI 服务可用性 |
...
使用 ip-api.com + ipinfo.io 双源交叉验证。检测机房/代理标签、ISP、ASN。免费 API 无法覆盖所有流媒体解锁状态，仅供参考。
...
> 💝 IP检测/测速灵感来自 [proxy-installer](https://github.com/FengZi1221/proxy-installer)
